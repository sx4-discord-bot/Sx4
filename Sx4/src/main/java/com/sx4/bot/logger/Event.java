...
public enum Event {
	...
	TEXT_CHANNEL_OVERRIDE_UPDATE(33, Category.CHANNEL, Category.MEMBER, Category.ROLE),
	TEXT_CHANNEL_OVERRIDE_DELETE(34, Category.CHANNEL, Category.MEMBER, Category.ROLE),
	TEXT_CHANNEL_OVERRIDE_CREATE(35, Category.CHANNEL, Category.MEMBER, Category.ROLE),
	STORE_CHANNEL_OVERRIDE_UPDATE(36, Category.CHANNEL, Category.MEMBER, Category.ROLE),
	STORE_CHANNEL_OVERRIDE_DELETE(37, Category.CHANNEL, Category.MEMBER, Category.ROLE),
	STORE_CHANNEL_OVERRIDE_CREATE(38, Category.CHANNEL, Category.MEMBER, Category.ROLE),
	VOICE_CHANNEL_OVERRIDE_UPDATE(39, Category.CHANNEL, Category.MEMBER, Category.ROLE),
	VOICE_CHANNEL_OVERRIDE_DELETE(40, Category.CHANNEL, Category.MEMBER, Category.ROLE),
	VOICE_CHANNEL_OVERRIDE_CREATE(41, Category.CHANNEL, Category.MEMBER, Category.ROLE);
