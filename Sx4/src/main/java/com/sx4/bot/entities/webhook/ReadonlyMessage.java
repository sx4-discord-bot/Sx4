...
public class ReadonlyMessage extends club.minnced.discord.webhook.receive.ReadonlyMessage {
	...
	public ReadonlyMessage(club.minnced.discord.webhook.receive.ReadonlyMessage message, long webhookId, String webhookToken) {
		super(message.getId(), message.getChannelId(), message.isMentionsEveryone(), message.isTTS(), 0, message.getAuthor(), message.getContent(), message.getEmbeds(), message.getAttachments(), message.getMentionedUsers(), message.getMentionedRoles());
