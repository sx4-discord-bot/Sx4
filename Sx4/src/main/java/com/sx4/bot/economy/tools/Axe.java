...
public class Axe extends Tool {
	...
	public static final Axe WOOD = new Axe("Wooden Axe", 180L, new CraftingRecipe(Wood.OAK, 2), Wood.OAK, 1, 12, 0.12);
	...
	public static final Axe BITCOIN = new Axe("Bitcoin Axe", 18200L, new CraftingRecipe(Material.BITCOIN, 1, Wood.SNAKEWOOD, 1), Material.BITCOIN, 4, 45, 0.53);
	public static final Axe PLATINUM = new Axe("Platinum Axe", 32000L, new CraftingRecipe(Material.PLATINUM, 1), Material.PLATINUM, 5, 55, 0.65);
	public static final Axe SX4 = new Axe("Sx4 Axe", 63000L, null, null, 6, 60, 0.85);
