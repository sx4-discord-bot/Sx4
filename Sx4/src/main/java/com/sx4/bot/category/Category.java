...
public class Category {
	...
	public static final Sx4Category AUTO_MODERATION = new Sx4Category("Auto Moderation", "This modules has commands which will moderate your server automatically", Category.ALL, "Auto Mod", "Auto Moderation");
