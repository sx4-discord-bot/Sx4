...
public class TemporaryBanEvent extends BanEvent {

	public TemporaryBanEvent(Member moderator, User target, Reason reason, boolean member, long duration) {
		super(moderator, target, reason, new TimeAction(ModAction.TEMPORARY_BAN, duration), member);
	}
